...
import Apruv from '../assets/team_members/Apruv.webp'
import Varshitha from '../assets/team_members/Varshitha.webp'
...
const Web3=[
    ...
    {pic:Aakash,domain:"Web3",role:"Member",id:67,name:"Aakash"}
...
const Content=[
  {pic:Apruv,domain:"Content Developer",role:"Member",id:26,name:"Apurv Kumar Jha"},
  {pic:Varshitha,domain:"Content Developer",role:"Member",id:27,name:"Varshitha M"},
  ...
  {pic:Aswath,domain:"Event & Promotions",role:"Lead",id:20,name:"Ashwath Krishna K"},
    {pic:Adhiti,domain:"Event & Promotions",role:"Member",id:21,name:"Adithi Rajesh"},
